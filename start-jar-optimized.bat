...
if not exist "target\excel-comparison-tool-1.0.0.jar" (
    echo Error: JAR file not found: target\excel-comparison-tool-1.0.0.jar
...
java %JVM_ARGS% -jar target\excel-comparison-tool-1.0.0.jar
